...
function Slider() {
  return (
    <div className="flex space-x-7 overflow-x-auto snap-x snap-mandatory scrollbar-hide">
      <div className="p-10 max-w-[533px] h-[541px] relative bg-[url('/images/testimonial.svg')] bg-cover bg-center rounded-2xl snap-start flex-shrink-0">
        <div className="absolute inset-0 bg-gradient-to-b from-transparent to-black opacity-90 rounded-2xl z-0"></div>
        <div className="relative flex flex-col justify-between space-y-52 z-20">
      ...
      {individuals.map((item) => (
        <div
          ...
          } rounded-2xl flex flex-col justify-between text-white max-w-[437px] snap-start flex-shrink-0`}
        >
